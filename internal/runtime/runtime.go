...
func configFields() []ConfigField {
	...
	return []ConfigField{
		...
		{Name: "priority_rules.claude.start_priority", Type: "integer", Description: localizedDescription("Claude 可用凭证起始优先级。默认 100。", "Claude start priority for available credentials. Default 100."), DefaultValue: rules.Claude.StartPriority},
